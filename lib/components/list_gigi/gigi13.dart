...
class Caninus_KananAtas extends StatefulWidget {
  final int number;

  const Caninus_KananAtas({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Caninus_KananAtas createState() => _Caninus_KananAtas();
}

class _Caninus_KananAtas extends State<Caninus_KananAtas> {
