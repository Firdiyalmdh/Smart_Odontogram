...
class Insisiv1_KananAtas extends StatefulWidget {
  final int number;

  const Insisiv1_KananAtas({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Insisiv1_KananAtas createState() => _Insisiv1_KananAtas();
}

class _Insisiv1_KananAtas extends State<Insisiv1_KananAtas> {
