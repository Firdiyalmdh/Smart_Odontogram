...
class Premolar1_KananBawah extends StatefulWidget {
  final int number;

  const Premolar1_KananBawah({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Premolar1_KananBawah createState() => _Premolar1_KananBawah();
}

class _Premolar1_KananBawah extends State<Premolar1_KananBawah> {
