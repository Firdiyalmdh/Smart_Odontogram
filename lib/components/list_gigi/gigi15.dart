...
class Premolar2_KananAtas extends StatefulWidget {
  final int number;

  const Premolar2_KananAtas({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Premolar2_KananAtas createState() => _Premolar2_KananAtas();
}

class _Premolar2_KananAtas extends State<Premolar2_KananAtas> {
  List<String> JenisGigi = ["Premolar 2"];
