...
class Molar3_KananBawah extends StatefulWidget {
  final int number;

  const Molar3_KananBawah({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Molar3_KananBawah createState() => _Molar3_KananBawah();
}

class _Molar3_KananBawah extends State<Molar3_KananBawah> {
