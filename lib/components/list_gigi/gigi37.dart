...
class Molar2_KiriBawah extends StatefulWidget {
  final int number;

  const Molar2_KiriBawah({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Molar2_KiriBawah createState() => _Molar2_KiriBawah();
}

class _Molar2_KiriBawah extends State<Molar2_KiriBawah> {
