...
class Insisiv2_KiriBawah extends StatefulWidget {
  final int number;

  const Insisiv2_KiriBawah({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Insisiv2_KiriBawah createState() => _Insisiv2_KiriBawah();
}

class _Insisiv2_KiriBawah extends State<Insisiv2_KiriBawah> {
