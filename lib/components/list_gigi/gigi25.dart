...
class Premolar2_KiriAtas extends StatefulWidget {
  final int number;

  const Premolar2_KiriAtas({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Premolar2_KiriAtas createState() => _Premolar2_KiriAtas();
}

class _Premolar2_KiriAtas extends State<Premolar2_KiriAtas> {
