...
class Molar3_KiriBawah extends StatefulWidget {
  final int number;

  const Molar3_KiriBawah({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Molar3_KiriBawah createState() => _Molar3_KiriBawah();
}

class _Molar3_KiriBawah extends State<Molar3_KiriBawah> {
