...
class Premolar1_KiriBawah extends StatefulWidget {
  final int number;

  const Premolar1_KiriBawah({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Premolar1_KiriBawah createState() => _Premolar1_KiriBawah();
}

class _Premolar1_KiriBawah extends State<Premolar1_KiriBawah> {
