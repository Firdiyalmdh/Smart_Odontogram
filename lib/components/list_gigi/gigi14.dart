...
class Premolar1_KananAtas extends StatefulWidget {
  final int number;

  const Premolar1_KananAtas({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Premolar1_KananAtas createState() => _Premolar1_KananAtas();
}

class _Premolar1_KananAtas extends State<Premolar1_KananAtas> {
