...
class Premolar1_KiriAtas extends StatefulWidget {
  final int number;

  const Premolar1_KiriAtas({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Premolar1_KiriAtas createState() => _Premolar1_KiriAtas();
}

class _Premolar1_KiriAtas extends State<Premolar1_KiriAtas> {
