...
class Premolar2_KananBawah extends StatefulWidget {
  final int number;

  const Premolar2_KananBawah({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Premolar2_KananBawah createState() => _Premolar2_KananBawah();
}

class _Premolar2_KananBawah extends State<Premolar2_KananBawah> {
  List<String> JenisGigi = ["Premolar2"];
