...
class Insisiv1_KananBawah extends StatefulWidget {
  final int number;

  const Insisiv1_KananBawah({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Insisiv1_KananBawah createState() => _Insisiv1_KananBawah();
}

class _Insisiv1_KananBawah extends State<Insisiv1_KananBawah> {
  List<String> JenisGigi = ["Insisiv1"];
