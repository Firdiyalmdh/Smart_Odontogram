...
class Molar2_KiriAtas extends StatefulWidget {
  final int number;

  const Molar2_KiriAtas({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Molar2_KiriAtas createState() => _Molar2_KiriAtas();
}

class _Molar2_KiriAtas extends State<Molar2_KiriAtas> {
