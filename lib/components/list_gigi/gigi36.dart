...
class Molar1_KiriBawah extends StatefulWidget {
  final int number;

  const Molar1_KiriBawah({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Molar1_KiriBawah createState() => _Molar1_KiriBawah();
}

class _Molar1_KiriBawah extends State<Molar1_KiriBawah> {
