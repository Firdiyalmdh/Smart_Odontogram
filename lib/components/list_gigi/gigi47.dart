...
class Molar2_KananBawah extends StatefulWidget {
  final int number;

  const Molar2_KananBawah({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Molar2_KananBawah createState() => _Molar2_KananBawah();
}

class _Molar2_KananBawah extends State<Molar2_KananBawah> {
  List<String> JenisGigi = ["Molar2"];
