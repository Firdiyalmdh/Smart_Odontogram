...
class Molar1_KananBawah extends StatefulWidget {
  final int number;

  const Molar1_KananBawah({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Molar1_KananBawah createState() => _Molar1_KananBawah();
}

class _Molar1_KananBawah extends State<Molar1_KananBawah> {
