...
class Insisiv2_KananAtas extends StatefulWidget {
  final int number;

  const Insisiv2_KananAtas({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Insisiv2_KananAtas createState() => _Insisiv2_KananAtas();
}

class _Insisiv2_KananAtas extends State<Insisiv2_KananAtas> {
