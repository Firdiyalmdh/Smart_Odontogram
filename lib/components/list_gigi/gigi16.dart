...
class Molar1_KananAtas extends StatefulWidget {
  final int number;

  const Molar1_KananAtas({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Molar1_KananAtasState createState() => _Molar1_KananAtasState();
}

class _Molar1_KananAtasState extends State<Molar1_KananAtas> {
  List<String> JenisGigi = ["Molar 1"];
