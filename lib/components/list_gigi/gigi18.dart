...
class Molar3_KananAtas extends StatefulWidget {
  final int number;

  const Molar3_KananAtas({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Molar3_KananAtasState createState() => _Molar3_KananAtasState();
}

class _Molar3_KananAtasState extends State<Molar3_KananAtas> {
  List<String> JenisGigi = ["Molar 3"];
