...
class Insisiv1_KiriAtas extends StatefulWidget {
  final int number;

  const Insisiv1_KiriAtas({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Insisiv1_KiriAtas createState() => _Insisiv1_KiriAtas();
}

class _Insisiv1_KiriAtas extends State<Insisiv1_KiriAtas> {
