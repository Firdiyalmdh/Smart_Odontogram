...
class Caninus_KiriBawah extends StatefulWidget {
  final int number;

  const Caninus_KiriBawah({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Caninus_KiriBawah createState() => _Caninus_KiriBawah();
}

class _Caninus_KiriBawah extends State<Caninus_KiriBawah> {
