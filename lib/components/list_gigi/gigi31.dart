...
class Insisiv1_KiriBawah extends StatefulWidget {
  final int number;

  const Insisiv1_KiriBawah({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Insisiv1_KiriBawah createState() => _Insisiv1_KiriBawah();
}

class _Insisiv1_KiriBawah extends State<Insisiv1_KiriBawah> {
