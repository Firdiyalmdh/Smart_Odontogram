...
class Caninus_KananBawah extends StatefulWidget {
  final int number;

  const Caninus_KananBawah({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Caninus_KananBawah createState() => _Caninus_KananBawah();
}

class _Caninus_KananBawah extends State<Caninus_KananBawah> {
  List<String> JenisGigi = ["Caninus"];
