...
class Caninus_KiriAtas extends StatefulWidget {
  final int number;

  const Caninus_KiriAtas({
    Key? key,
    required this.number,
  }) : super(key: key);

  @override
  _Caninus_KiriAtas createState() => _Caninus_KiriAtas();
}

class _Caninus_KiriAtas extends State<Caninus_KiriAtas> {
