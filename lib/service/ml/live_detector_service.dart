...
class LiveDetectorService {
  static const String _modelPath = 'assets/efficientdet.tflite';
  static const String _labelPath = 'assets/efficientdet.txt';

  LiveDetectorService._(this._isolate, this._interpreter, this._labels);
  ...
  static Future<LiveDetectorService> start() async {
    final ReceivePort receivePort = ReceivePort();
    final Isolate isolate =
        await Isolate.spawn(_DetectorServer._run, receivePort.sendPort);

    final LiveDetectorService result = LiveDetectorService._(
      isolate,
      await _loadModel(),
      await _loadLabels(),
    );
